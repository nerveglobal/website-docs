...
import UGP from '@site/static/img/UGP.gif';
...
import True from '../css/fontTrue.css';

import { BookOpenIcon, ChatIcon, CodeIcon, InformationCircleIcon, QuestionMarkCircleIcon } from '@heroicons/react/outline';
...
export const github = [
	{
		title: 'Contracts',
		href: 'https://github.com/nerveglobal/contracts',
		icon: CodeIcon,
	},
	{
		title: 'Subgraphs',
		href: 'https://github.com/nerveglobal/subgraphs',
		icon: CodeIcon,
	},
	{
		title: 'Brand Assets',
	...
	{
		title: 'Website',
		href: 'https://github.com/nerveglobal/website',
	},
];
...
export const Guides = [
	{
		...
		text: 'The first peer-to-peer crowdfunding application',
		to: './protocol/what-is-nerve',
	},
	{
		title: 'Being recognized',
		text: 'Register a memorable and unique username',
...
export default function Home() {
	return (
		<Layout title={`Nerve Docs`} description="Technical Documentation for Nerve">
			<Container>
				<DocsHeader>
					<div
						style={{
					...
					>
						<h1 style={{ fontFamily: 'True' }}> Welcome to the Nerve Docs</h1>
						<HideMedium>
							<SearchBar />{' '}
						</HideMedium>
					</div>
							...
							<Link style={{ textDecoration: 'none' }} to={action.to}>
								<ShadowCard key={action.title}>
									<TopSection>
										...
										<svg style={{ width: '24px', opacity: 0.2 }} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
											<path d="M20 4h1a1 1 0 00-1-1v1zm-1 12a1 1 0 102 0h-2zM8 3a1 1 0 000 2V3zM3.293 19.293a1 1 0 101.414 1.414l-1.414-1.414zM19 4v12h2V4h-2zm1-1H8v2h12V3zm-.707.293l-16 16 1.414 1.414 16-16-1.414-1.414z" />
										</svg>
									</TopSection>
									<h3 style={{ marginBottom: '.75rem', color: action.color }}>{action.title}</h3>
									<p style={{ marginBottom: '.5rem' }}>{action.text}</p>
								</ShadowCard>
							</Link>
						))}
					</Row>
				...
				>
					<div>
						<h2 style={{ fontFamily: 'True' }}>Getting Started</h2>
						<p>Explore these docs to get started using the Nerve smart contracts in our dApp, for your project.</p>
						<div>
							{Guides.map((action) => (
					...
					<div>
						<h2 style={{ fontFamily: 'True' }}>Developer Links</h2>
						<p>The Nerve codebase is comprised of an ecosystem of open source components.</p>
						{github.map((action) => (
											...
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120.78 117.79" style={{ width: '24px' }}>
												...
												<g id="Layer_2" data-name="Layer 2">
													<g id="Layer_1-2" data-name="Layer 1">
														...
														/>
														<path class="cls-2" d="M22.87,86.7c-.13.3-.6.39-1,.19s-.69-.61-.55-.91.61-.39,1-.19.69.61.54.91Z" />
														<path
															class="cls-2"
														...
														<path class="cls-2" d="M31,96.27A1.13,1.13,0,0,1,29.41,96c-.53-.49-.68-1.18-.34-1.54s1-.27,1.56.23.68,1.18.33,1.54Z" />
														<path class="cls-2" d="M35.46,98.22c-.15.47-.82.69-1.51.49s-1.13-.76-1-1.24.82-.7,1.51-.49,1.13.76,1,1.24Z" />
														<path class="cls-2" d="M40.4,98.58c0,.5-.56.91-1.28.92s-1.3-.38-1.31-.88.56-.91,1.29-.92,1.3.39,1.3.88Z" />
														<path class="cls-2" d="M45,97.8c.09.49-.41,1-1.12,1.12s-1.35-.17-1.44-.66.42-1,1.12-1.12,1.35.17,1.44.66Z" />
													</g>
												</g>
											</svg>
        ...
        <Row>
          ...
          >
            <CenterCard>
              ...
              <div>
                <h3>Github</h3>
                <p>View all Nerve repositories.</p>
              </div>
            </CenterCard>
          </Link>
        </Row>
        ...
        >
          ...
          >
            ...
            <div>
              <h2 style={{ marginBottom: "0.5rem" }}>Nerve Grants Program - Coming soon</h2>
              <p style={{ margin: "0rem" }}>
                Nerve Foundation offers grant funding for people who are
                building communitys, apps, tools, and activities for Nerve users,
